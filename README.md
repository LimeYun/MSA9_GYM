...
<p>그리고 사용자에게 보여지는 화면을 구성하는 View를 명확히 구분할 수 있었습니다.</p>
...
<p>그리고 캘린더 API와 데이터베이스를 연결하는 자바스크립트 코드를 작성하는 과정에서 어려움을 겪었기에,</p>
